...
class YoloSegmentationDialog(BaseDialog):
    def __init__(self, parent=None):
        ...
        self.confidence_spinbox = CustomDoubleSpinBox()
        self.confidence_spinbox.setRange(0.0, 1.0); self.confidence_spinbox.setSingleStep(0.05); self.confidence_spinbox.setValue(0.4)
    ...
    def start_processing(self):
        ...
        # CORRECTED CONSTRUCTOR CALL (No batch size)
        self.yolo_worker = YoloSegmentationProcessor(
            self.video_files, 
